...
TASK = Task(
    ...
    statement=Statement(
        ...
        Напишите функцию `unique(a)`, принимающую один аргумент \N{EN DASH} массив из произвольных 
        элементов, и возвращающую массив из тех же элементов в том же порядке, но с удаленными 
        повторениями.
