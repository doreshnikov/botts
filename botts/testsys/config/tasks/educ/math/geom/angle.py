...
TASK = Task(
    ...
    statement=Statement(
        ...
        Напишите функцию `angle(a, b, c)`, принимающую координаты трех точек на плоскости (как `tuple[float, float]`) 
        и возвращающую величину угла на этих трех точках (с вершиной во второй из них, то есть угла `abc`).
