...
TASK = Task(
    ...
    statement=Statement(
        md=textwrap.dedent('''
        Даны координаты трех точек на плоскости (как `tuple[float, float]`).
        Определите величину угла на этих трех точках (с вершиной во второй из них).
        Ответ требуется вывести в *градусах* от 0 до 360.
        ''')
    ),
